  ...
  return (
    <>
      <group {...props} dispose={null}>
        ...
        {/* inner */}
        <ColliderBox position={[-0.1, 1, -0.53]} scale={[10.5, 10, 0.2]} />
        <ColliderBox position={[-0.7, 1, -2.98]} scale={[9.47, 10, 0.2]} />
        <ColliderBox position={[6, 1, 2.2]} scale={[1.8, 10, 8.9]} />
        <ColliderBox position={[-6.4, 1, -3]} scale={[2.3, 10, 9.3]} />
        <ColliderBox position={[-6.9, 1, 10.5]} scale={[12.3, 10, 4.0]} />
        <ColliderBox position={[9, 1, -10.5]} scale={[7, 10, 4.0]} />
        <ColliderBox position={[1.2, 1, 2.0]} scale={[1, 10, 0.4]} />
        <ColliderBox position={[9, 1, 3.9]} scale={[0.3, 10, 0.4]} />
        <ColliderBox position={[9.4, 1, 5.7]} scale={[0.3, 10, 0.4]} />
        <ColliderBox position={[8.45, 1, 8.7]} scale={[0.3, 10, 0.4]} />
        <ColliderBox position={[7.8, 1, -2.3]} scale={[0.3, 10, 0.4]} />
        <ColliderBox position={[5, 1, -4.3]} scale={[0.3, 10, 0.4]} />
        <ColliderBox position={[3.9, 1, -2.55]} scale={[0.3, 10, 0.7]} />
        <ColliderBox position={[4.5, 1, -2.1]} scale={[1.1, 10, 0.2]} />
        <ColliderBox position={[2.8, 1, -5.5]} scale={[0.3, 10, 0.4]} />
        <ColliderBox position={[-9.7, 1, -5.7]} scale={[1, 10, 2.5]} />
        <ColliderBox position={[-7.8, 1, 2]} scale={[1, 10, 2.5]} />
      </group>
    </>
  );
}
